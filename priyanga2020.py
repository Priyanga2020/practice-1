...
layout = [
    ...
    [sg.Listbox(values=[todolist][0], size=(40, 10), font=("Arial", 14), key='todolist'), sg.Button("Edit", font=("Arial", 14)),
     sg.Button("Delete", font=("Arial", 14)),sg.Button("your favourites", font=("Arial", 14)),
     sg.Button("save main task")],
    [sg.Text("YOUR FAVOURTES", font=("Arial", 14), size =(40,1))],
    [sg.Listbox(values=[todolist1][0], size=(40,10), font=("Arial", 14) , key='todolist1'),
     sg.Button("save your favourites"),sg.Button("sort your favourites")]
...
while True:
    ...
    elif event == 'save main task':
        save_tasks()
    elif event == 'sort your favourites':
        sort_fav_tasks()
    elif event == 'save your favourites':
        save_fav_tasks()
    else:
        break
